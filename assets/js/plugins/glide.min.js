    ...
    (t(m, [
      ...
      },
      {
        ...
        value: function (t) {
          var e = 0 < arguments.length && void 0 !== t ? t : {}
          return (
            (this.settings = h(this.settings, e)), e.hasOwnProperty('startAt') && (this.index = e.startAt), this._e.emit('update'), this
          )
        },
      },
      {
        ...
        u = {
          match: function (t) {
            if (void 0 !== window.matchMedia)
              for (var e in t) if (t.hasOwnProperty(e) && window.matchMedia('(max-width: ' + e + 'px)').matches) return t[e]
            return s
          },
        }
      return (
